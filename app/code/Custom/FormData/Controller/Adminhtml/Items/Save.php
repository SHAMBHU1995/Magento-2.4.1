...
namespace Custom\FormData\Controller\Adminhtml\Items;

class Save extends \Custom\FormData\Controller\Adminhtml\Items
{
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
                $model = $this->_objectManager->create('Custom\FormData\Model\FormData');
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('custom_formdata/*/edit', ['id' => $model->getId()]);
                    return;
                }
                $this->_redirect('custom_formdata/*/');
                return;
            } catch (\Magento\Framework\Exception\LocalizedException $e) {
                $this->messageManager->addError($e->getMessage());
                $id = (int)$this->getRequest()->getParam('id');
                if (!empty($id)) {
                    $this->_redirect('custom_formdata/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('custom_formdata/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('custom_formdata/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('custom_formdata/*/');
